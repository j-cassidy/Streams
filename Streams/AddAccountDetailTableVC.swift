...
class AddAccountDetailTableVC: UITableViewController {

    @IBOutlet weak var profilePicture: UIImageView!
    @IBOutlet weak var nameField: UIStackView!
    @IBOutlet weak var emailField: UITextField!
    @IBOutlet weak var cellNumberField: UITextField!
    @IBOutlet weak var mainAddressField: UITextField!
    @IBOutlet weak var secondAddressField: UITextField!
    ...
    @IBAction func saveBarButtonPressed(_ sender: UIButton) {
    }
